        ...
        <div className="w-1/3 flex flex-col space-y-4 mt-10 gap-10">
          <div>
            <img
              ...
              alt="Linear damper structure 1"
              className="rounded-md"
            />
            <p className="text-center text-sm mt-2">Component Display</p>
          </div>
          <div>
            <img
              src="/images/products/how_lineardamper_work_2.png"
              alt="Linear damper structure 2"
              className="rounded-md"
            />
            <p className="text-center text-sm mt-2">Part Information</p>
          </div>
        </div>
      </div>
    </section>
